...
namespace Microsoft.Health.Dicom.Client
{
    public interface IDicomWebClient
    {
        ...
        Task<DicomWebResponse<IReadOnlyList<Stream>>> RetrieveFramesAsync(Uri requestUri, string contentType = DicomWebConstants.ApplicationOctetStreamContentType, string dicomTransferSyntax = DicomWebConstants.OriginalDicomTransferSyntax, CancellationToken cancellationToken = default);
