...
namespace Microsoft.Health.Dicom.Client
{
    public interface IDicomWebClient
    {
        ...
        Task<DicomWebResponse> AddExtendedQueryTagAsync(IEnumerable<AddExtendedQueryTag> tagEntries, CancellationToken cancellationToken = default);

        Task<DicomWebResponse> DeleteExtendedQueryTagAsync(string tagPath, CancellationToken cancellationToken = default);

        Task<DicomWebResponse<IEnumerable<GetExtendedQueryTag>>> GetExtendedQueryTagsAsync(CancellationToken cancellationToken = default);

        Task<DicomWebResponse<GetExtendedQueryTag>> GetExtendedQueryTagAsync(string tagPath, CancellationToken cancellationToken = default);
    }
}
