...
{
    Task<DicomWebResponse<Stream>> RetrieveSingleFrameAsync(string studyInstanceUid, string seriesInstanceUid, string sopInstanceUid, int frame, string partitionName = default, bool requestOriginalVersion = default, CancellationToken cancellationToken = default);
    ...
    Task<DicomWebResponse<Stream>> RetrieveRenderedFrameAsync(string studyInstanceUid, string seriesInstanceUid, string sopInstanceUid, int frame, int quality = 100, string mediaType = DicomWebConstants.ImageJpegMediaType, string partitionName = default, bool requestOriginalVersion = default, CancellationToken cancellationToken = default);
    ...
    Task<DicomWebResponse<Stream>> RetrieveRenderedInstanceAsync(string studyInstanceUid, string seriesInstanceUid, string sopInstanceUid, int quality = 100, string mediaType = DicomWebConstants.ImageJpegMediaType, string partitionName = default, bool requestOriginalVersion = default, CancellationToken cancellationToken = default);
