...
public partial interface IDicomWebClient
{
    ...
    Task<DicomWebResponse<Stream>> RetrieveSeriesStreamAsync(string studyInstanceUid, string seriesInstanceUid, string dicomTransferSyntax = DicomWebConstants.OriginalDicomTransferSyntax, string partitionName = default, bool requestOriginalVersion = default, CancellationToken cancellationToken = default);
    Task<DicomWebResponse<Stream>> RetrieveStudyStreamAsync(string studyInstanceUid, string dicomTransferSyntax = DicomWebConstants.OriginalDicomTransferSyntax, string partitionName = default, bool requestOriginalVersion = default, CancellationToken cancellationToken = default);
