...
public partial interface IDicomWebClient
{
    ...
    Task<DicomWebResponse> RetrieveInstanceResponseAsync(string studyInstanceUid, string seriesInstanceUid, string sopInstanceUid, string dicomTransferSyntax = DicomWebConstants.OriginalDicomTransferSyntax, string partitionName = default, bool requestOriginalVersion = default, CancellationToken cancellationToken = default);
    Task<DicomWebResponse> RetrieveSeriesResponseAsync(string studyInstanceUid, string seriesInstanceUid, string dicomTransferSyntax = DicomWebConstants.OriginalDicomTransferSyntax, string partitionName = default, bool requestOriginalVersion = default, CancellationToken cancellationToken = default);
    Task<DicomWebResponse> RetrieveStudyResponseAsync(string studyInstanceUid, string dicomTransferSyntax = DicomWebConstants.OriginalDicomTransferSyntax, string partitionName = default, bool requestOriginalVersion = default, CancellationToken cancellationToken = default);
