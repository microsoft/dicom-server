...
namespace Microsoft.Health.Dicom.Transactional.Features.Health
{
    /// <summary>
    /// Checks for the DICOM metadata service health.
    /// </summary>
    public class DicomTransactionHealthCheck : BlobHealthCheck
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DicomTransactionHealthCheck"/> class.
        /// </summary>
        ...
        public DicomTransactionHealthCheck(
            ...
            ILogger<DicomTransactionHealthCheck> logger)
            : base(
                  client,
                  configuration,
