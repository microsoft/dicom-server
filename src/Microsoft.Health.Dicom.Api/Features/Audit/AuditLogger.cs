...
#pragma warning disable CA2254
        ...
        _logger.LogInformation(
            ...
            auditAction,
            AuditEventType,
            _securityConfiguration.AlternativeAuthenticationSchemes.FirstOrDefault()?.Audience,
            _securityConfiguration.AlternativeAuthenticationSchemes.FirstOrDefault()?.Authority,
            requestUri,
            operation,
            statusCode,
            correlationId,
