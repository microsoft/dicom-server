...
namespace Microsoft.Health.Dicom.Core.Features.CustomTag
{
    public interface ICustomTagStore
    {
        ...
        Task<IEnumerable<VersionedInstanceIdentifier>> GetEarilierInstancesAsync(long endWatermark, int top, IndexStatus indexStatus = IndexStatus.Created, CancellationToken cancellationToken = default);
    }
}
