...
public interface IIndexDataStore
{
    ...
    /// <param name="instanceStorageKey">Key representing instance storage unique fields</param>
    /// <param name="queryTags">Queryable dicom tags</param>
    ...
    Task EndCreateInstanceIndexAsync(int partitionKey, DicomDataset dicomDataset, InstanceStorageKey instanceStorageKey, IEnumerable<QueryTag> queryTags, FileProperties fileProperties = null, bool allowExpiredTags = false, bool hasFrameMetadata = false, CancellationToken cancellationToken = default);
