...
public interface IIndexDataStore
{
    ...
    Task EndCreateInstanceIndexAsync(int partitionKey, DicomDataset dicomDataset, long watermark, IEnumerable<QueryTag> queryTags, bool allowExpiredTags = false, bool hasFrameMetadata = false, FileProperty fileProperty = null, CancellationToken cancellationToken = default);
