...
public interface IIndexDataStore
{
    ...
    /// <param name="version">The DICOM instance watermark</param>
    /// <param name="queryTags">Queryable dicom tags</param>
    ...
    Task EndCreateInstanceIndexAsync(int partitionKey, DicomDataset dicomDataset, long version, IEnumerable<QueryTag> queryTags, FileProperties fileProperties = null, bool allowExpiredTags = false, bool hasFrameMetadata = false, CancellationToken cancellationToken = default);
