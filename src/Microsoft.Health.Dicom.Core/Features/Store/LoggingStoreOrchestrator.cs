...
namespace Microsoft.Health.Dicom.Core.Features.Store
{
    ...
    public class LoggingStoreOrchestrator : IStoreOrchestrator
    {
        ...
        /// <inheritdoc />
        public async Task StoreDicomInstanceEntryAsync(IDicomInstanceEntry dicomInstanceEntry, IList<CustomTagEntry> customTagEntries, CancellationToken cancellationToken)
        {
