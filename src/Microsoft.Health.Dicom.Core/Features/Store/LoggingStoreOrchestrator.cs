...
namespace Microsoft.Health.Dicom.Core.Features.Store
{
    ...
    public class LoggingStoreOrchestrator : IStoreOrchestrator
    {
        ...
        /// <inheritdoc />
        public async Task StoreDicomInstanceEntryAsync(IDicomInstanceEntry dicomInstanceEntry, IReadOnlyList<CustomTagEntry> customTagEntries, CancellationToken cancellationToken)
        {
            ...
            try
            {
                await _storeOrchestrator.StoreDicomInstanceEntryAsync(dicomInstanceEntry, customTagEntries, cancellationToken);
