...
namespace Microsoft.Health.Dicom.Core.Features.ExtendedQueryTag
{
    ...
    public interface IExtendedQueryTagStore
    {
        ...
        Task<IEnumerable<ExtendedQueryTagStoreEntry>> AddExtendedQueryTagsAsync(IEnumerable<AddExtendedQueryTagEntry> extendedQueryTagEntries, CancellationToken cancellationToken = default);
