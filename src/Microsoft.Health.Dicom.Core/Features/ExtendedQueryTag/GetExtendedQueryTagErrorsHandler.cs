...
namespace Microsoft.Health.Dicom.Core.Features.ExtendedQueryTag
{
    ...
    {
        private readonly IGetExtendedQueryTagErrorsService _getExtendedQueryTagErrorsService;
        public GetExtendedQueryTagErrorsHandler(IAuthorizationService<DataActions> authorizationService, IGetExtendedQueryTagErrorsService getExtendedQueryTagErrorsService)
