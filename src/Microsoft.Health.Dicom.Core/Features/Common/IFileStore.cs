...
public interface IFileStore
{
    ...
    Task<Uri> StoreFileInBlocksAsync(long version, string partitionName, Stream stream, IDictionary<string, long> blockLengths, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns></returns>
    Task<BinaryData> GetFileContentInRangeAsync(long version, string partitionName, FrameRange range, CancellationToken cancellationToken = default);
    ...
    Task UpdateFileBlockAsync(long version, string partitionName, string blockId, Stream stream, CancellationToken cancellationToken = default);
    ...
    Task<KeyValuePair<string, long>> GetFirstBlockPropertyAsync(long version, string partitionName, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns></returns>
    Task CopyFileAsync(long originalVersion, long newVersion, string partitionName, CancellationToken cancellationToken = default);
}
