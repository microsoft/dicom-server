            ...
            try
            {
                ...
                foreach (InstanceMetadata deletedInstanceIdentifier in deletedInstanceIdentifiers)
                {
                    try
                    {
                        Task[] tasks = new[]
                        {
                            _fileStore.DeleteFileIfExistsAsync(deletedInstanceIdentifier.VersionedInstanceIdentifier.Version, deletedInstanceIdentifier.VersionedInstanceIdentifier.PartitionKey, cancellationToken),
                        ...
                        if (deletedInstanceIdentifier.InstanceProperties.OriginalVersion.HasValue)
                        {
                            ...
                            {
                                _fileStore.DeleteFileIfExistsAsync(deletedInstanceIdentifier.InstanceProperties.OriginalVersion.Value, deletedInstanceIdentifier.VersionedInstanceIdentifier.PartitionKey, cancellationToken),
