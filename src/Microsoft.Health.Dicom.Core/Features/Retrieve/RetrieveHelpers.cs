...
{
    public static async Task<FileProperties> CheckFileSize(IFileStore blobDataStore, long maxDicomFileSize, long version, int partitionKey, bool render, CancellationToken cancellationToken)
    {
