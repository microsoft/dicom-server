...
namespace Microsoft.Health.Dicom.Core.Features.Operations
{
    ...
    public interface IDicomOperationsClient
    {
        ...
        /// </summary>
        /// <param name="tags">A collection of 1 or more existing query tags.</param>
        /// <param name="cancellationToken">
        /// The token to monitor for cancellation requests. The default value is <see cref="CancellationToken.None"/>.
        /// </param>
        /// <returns>
        /// A task representing the <see cref="StartQueryTagIndexingAsync"/> operation. The value of its
        /// <see cref="Task{TResult}.Result"/> property contains the ID of the operation
        ...
        /// <exception cref="OperationCanceledException">The <paramref name="cancellationToken"/> was canceled.</exception>
        Task<Guid> StartQueryTagIndexingAsync(IReadOnlyCollection<ExtendedQueryTagReference> tags, CancellationToken cancellationToken = default);
    }
}
