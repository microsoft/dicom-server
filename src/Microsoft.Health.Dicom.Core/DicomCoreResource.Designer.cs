...
namespace Microsoft.Health.Dicom.Core {
    ...
    internal class DicomCoreResource {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Value exceeds maximum length of {0} characters..
        /// </summary>
        internal static string ValueLengthExceedMaxAllowedLengthOfCharacters {
            get {
                return ResourceManager.GetString("ValueLengthExceedMaxAllowedLengthOfCharacters", resourceCulture);
            }
        }
