...
public static class DicomDatasetExtensions
{
    ...
    public static InstanceIdentifier ToInstanceIdentifier(this DicomDataset dicomDataset, PartitionEntry partitionEntry)
    {
        EnsureArg.IsNotNull(dicomDataset, nameof(dicomDataset));
    ...
    /// <param name="partitionEntry">Data Partition entry</param>
    /// <returns>An instance of <see cref="InstanceIdentifier"/> representing the <paramref name="dicomDataset"/>.</returns>
    public static VersionedInstanceIdentifier ToVersionedInstanceIdentifier(this DicomDataset dicomDataset, long version, PartitionEntry partitionEntry)
    {
        EnsureArg.IsNotNull(dicomDataset, nameof(dicomDataset));
