...
CREATE UNIQUE NONCLUSTERED INDEX IX_Instance_StudyInstanceUid_SeriesInstanceUid_SopInstanceUid
    ON dbo.Instance(StudyInstanceUid, SeriesInstanceUid, SopInstanceUid)
    INCLUDE(Status, Watermark) WITH (DATA_COMPRESSION = PAGE);

CREATE NONCLUSTERED INDEX IX_Instance_StudyInstanceUid_Status
    ON dbo.Instance(StudyInstanceUid, Status)
    INCLUDE(Watermark) WITH (DATA_COMPRESSION = PAGE);

CREATE NONCLUSTERED INDEX IX_Instance_StudyInstanceUid_SeriesInstanceUid_Status
    ON dbo.Instance(StudyInstanceUid, SeriesInstanceUid, Status)
    INCLUDE(Watermark) WITH (DATA_COMPRESSION = PAGE);

CREATE NONCLUSTERED INDEX IX_Instance_SopInstanceUid_Status
