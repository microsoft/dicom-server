...
/**************************************************************************************
    Partition Table
    Data partitions used for light-weight multitenancy for STOW, WADO, QIDO, and delete
**************************************************************************************/
CREATE TABLE dbo.Partition (
    PartitionKey            INT                    NOT NULL, --PK System-generated numeric key
    PartitionName           VARCHAR(64)            NOT NULL, --   Client-specified partition name. Can be a UID or GUID.
    --audit columns
...
--Filter indexes
CREATE UNIQUE NONCLUSTERED INDEX IX_Instance_StudyKey_StudyInstanceUid_SeriesInstanceUid_SopInstanceUid on dbo.Instance
(
    StudyKey,
    StudyInstanceUid,
    SeriesInstanceUid,
...
(
    ...
    PartitionName       VARCHAR(64)       NULL, --FK
    StudyInstanceUid    VARCHAR(64)       NOT NULL,
    SeriesInstanceUid   VARCHAR(64)       NOT NULL,
    SopInstanceUid      VARCHAR(64)       NOT NULL,
    Watermark           BIGINT            NOT NULL,
