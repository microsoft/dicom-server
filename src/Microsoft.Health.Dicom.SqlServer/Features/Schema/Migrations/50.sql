...
BEGIN
    ...
    IF EXISTS (SELECT 1
        ...
        BEGIN
            UPDATE EQT
            SET    EQT.TagValue = S.TagValue
            FROM   dbo.ExtendedQueryTagLong AS EQT
                   INNER JOIN
    ...
    IF EXISTS (SELECT 1
        ...
        BEGIN
            UPDATE EQT
            SET    EQT.TagValue = S.TagValue
            FROM   dbo.ExtendedQueryTagDouble AS EQT
                   INNER JOIN
    ...
    IF EXISTS (SELECT 1
        ...
        BEGIN
            ...
            FROM   dbo.ExtendedQueryTagDateTime AS EQT
                   INNER JOIN
    ...
    IF EXISTS (SELECT 1
        ...
        BEGIN
            UPDATE EQT
            SET    EQT.TagValue = S.TagValue
            FROM   dbo.ExtendedQueryTagPersonName AS EQT
                   INNER JOIN
