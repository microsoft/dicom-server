...
namespace Microsoft.Health.Dicom.SqlServer.Features.Schema.Model
{
    ...
    internal class VLatest
    {
        ...
        internal readonly static UpdateInstanceStatusV52Procedure UpdateInstanceStatusV52 = new UpdateInstanceStatusV52Procedure();
        ...
        internal class UpdateInstanceStatusV52Procedure : StoredProcedure
        {
            internal UpdateInstanceStatusV52Procedure() : base("dbo.UpdateInstanceStatusV52")
            {
            }
            ...
            {
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
                command.CommandText = "dbo.UpdateInstanceStatusV52";
                _partitionKey.AddParameter(command.Parameters, partitionKey);
                _studyInstanceUid.AddParameter(command.Parameters, studyInstanceUid);
                _seriesInstanceUid.AddParameter(command.Parameters, seriesInstanceUid);
                _sopInstanceUid.AddParameter(command.Parameters, sopInstanceUid);
