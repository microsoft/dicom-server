...
internal class SqlInstanceStoreV47 : SqlInstanceStoreV46
{
    public SqlInstanceStoreV47(SqlConnectionWrapperFactory sqlConnectionWrapperFactory) : base(sqlConnectionWrapperFactory)
    {
    }
