...
internal class SqlInstanceStoreV22 : SqlInstanceStoreV10
{
    public SqlInstanceStoreV22(SqlConnectionWrapperFactory sqlConnectionWrapperFactory) : base(sqlConnectionWrapperFactory)
    {
    }
