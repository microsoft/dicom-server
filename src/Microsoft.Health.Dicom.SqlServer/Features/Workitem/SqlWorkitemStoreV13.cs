...
{
    internal class SqlWorkitemStoreV13 : SqlWorkitemStoreV11
    {
        ...
        public SqlWorkitemStoreV13(SqlConnectionWrapperFactory sqlConnectionWrapperFactory, ILogger<ISqlWorkitemStore> logger)
