...
namespace Microsoft.Health.Dicom.SqlServer.Features.Store
{
    ...
    internal class SqlIndexDataStoreV1 : ISqlIndexDataStore
    {
        ...
        public virtual async Task<long> CreateInstanceIndexAsync(DicomDataset instance, IEnumerable<QueryTag> queryTags, ExtendedQueryTagsVersion extendedQueryTagETag, CancellationToken cancellationToken)
        {
