...
internal class SqlIndexDataStoreV51 : SqlIndexDataStoreV50
{
    public SqlIndexDataStoreV51(SqlConnectionWrapperFactory sqlConnectionWrapperFactory)
        : base(sqlConnectionWrapperFactory)
    {
    }

    public override SchemaVersion Version => SchemaVersion.V51;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            VLatest.UpdateInstanceStatusV51.PopulateCommand(
                sqlCommandWrapper,
                partitionKey,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var parameters = new VLatest.EndUpdateInstanceV51TableValuedParameters(
            filePropertiesRows,
            rows.StringRows,
            rows.LongRows,
            rows.DoubleRows,
        ...
        using SqlConnectionWrapper sqlConnectionWrapper = await SqlConnectionWrapperFactory.ObtainSqlConnectionWrapperAsync(cancellationToken);
        using SqlCommandWrapper sqlCommandWrapper = sqlConnectionWrapper.CreateRetrySqlCommand();
        VLatest.EndUpdateInstanceV51.PopulateCommand(
            sqlCommandWrapper,
            partitionKey,
            studyInstanceUid,
