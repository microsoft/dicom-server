...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class DicomSqlServerRegistrationExtensions
    {
        ...
        private static IServiceCollection AddSqlChangeFeedStore(this IServiceCollection services)
        {
            ...
            services.TryAddEnumerable(ServiceDescriptor.Scoped<ISqlChangeFeedStore, SqlChangeFeedStoreV1>());
            services.TryAddEnumerable(ServiceDescriptor.Scoped<ISqlChangeFeedStore, SqlChangeFeedStoreV2>());
            services.TryAddEnumerable(ServiceDescriptor.Scoped<ISqlChangeFeedStore, SqlChangeFeedStoreV3>());
        ...
        private static IServiceCollection AddSqlQueryStore(this IServiceCollection services)
        {
            ...
            services.TryAddEnumerable(ServiceDescriptor.Scoped<ISqlQueryStore, SqlQueryStoreV1>());
            services.TryAddEnumerable(ServiceDescriptor.Scoped<ISqlQueryStore, SqlQueryStoreV2>());
            services.TryAddEnumerable(ServiceDescriptor.Scoped<ISqlQueryStore, SqlQueryStoreV3>());
