...
public class AzureBlobExportSinkTests : IAsyncDisposable
{
    ...
    public async Task GivenValidReadResult_WhenCopying_ThenCopyToDestination()
    {
        ...
        _fileStore.GetStreamingFileAsync(identifier.Version, identifier.PartitionEntry.PartitionName, tokenSource.Token).Returns(fileStream);
        ...
        await _fileStore.Received(1).GetStreamingFileAsync(identifier.Version, identifier.PartitionEntry.PartitionName, tokenSource.Token);
