...
"
            ...
            store
                ...
                .Returns(
                    ...
                    {
                        new ExtendedQueryTagStoreEntry(1, "00101010", "AS", null, QueryTagLevel.Study, ExtendedQueryTagStatus.Adding, QueryTagQueryStatus.Enabled, 0),
                        new ExtendedQueryTagStoreEntry(4, "00104040", "DT", null, QueryTagLevel.Instance, ExtendedQueryTagStatus.Adding, QueryTagQueryStatus.Enabled, 0),
                    });
            handler.SendingAsync += (msg, token) => AssertExpectedStatusRequestAsync(msg, id);
