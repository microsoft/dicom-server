...
public class IdentifierExportSourceTests
{
    ...
    public async Task GivenInstances_WhenEnumerating_ThenYieldValues()
    {
        ...
        _store
            .GetInstanceIdentifiersInStudyAsync(_partition.PartitionKey, _partition.PartitionName, "10", tokenSource.Token)
            .Returns(expected[0..3]);
        _store
            .GetInstanceIdentifiersInStudyAsync(_partition.PartitionKey, _partition.PartitionName, "11", tokenSource.Token)
            .Returns(Array.Empty<VersionedInstanceIdentifier>());
        _store
            .GetInstanceIdentifiersInSeriesAsync(_partition.PartitionKey, _partition.PartitionName, "100", "200", tokenSource.Token)
            .Returns(expected[3..6]);
        _store
            .GetInstanceIdentifiersInSeriesAsync(_partition.PartitionKey, _partition.PartitionName, "100", "201", tokenSource.Token)
            .Returns(Array.Empty<VersionedInstanceIdentifier>());
        _store
            .GetInstanceIdentifierAsync(_partition.PartitionKey, _partition.PartitionName, "1000", "2000", "3000", tokenSource.Token)
            .Returns(new VersionedInstanceIdentifier[] { expected[6] });
        _store
            .GetInstanceIdentifierAsync(_partition.PartitionKey, _partition.PartitionName, "1000", "2000", "3001", tokenSource.Token)
            .Returns(Array.Empty<VersionedInstanceIdentifier>());
