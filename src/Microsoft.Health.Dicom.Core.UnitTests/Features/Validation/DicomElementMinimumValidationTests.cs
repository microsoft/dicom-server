...
namespace Microsoft.Health.Dicom.Core.UnitTests.Features.Validation
{
    public class DicomElementMinimumValidationTests
    {
        ...
        [Fact]
        public void GivenInvalidValue_WhenValidateWithDefaultValidator_Throws()
        {
            DicomElement element = new DicomAgeString(DicomTag.PatientAge, "0.1D");
            Assert.Throws<DicomElementValidationException>(() => DicomElementMinimumValidation.DefaultValidate(element));
        }
    }
}
