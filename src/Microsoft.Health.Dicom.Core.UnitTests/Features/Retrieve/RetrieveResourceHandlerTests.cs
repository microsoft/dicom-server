...
namespace Microsoft.Health.Dicom.Core.UnitTests.Features.Retrieve
{
    public class RetrieveResourceHandlerTests
    {
        ...
        {
            RetrieveResourceRequest request = new RetrieveResourceRequest("*", KnownContentTypes.ApplicationOctetStream, studyInstanceUid);
        ...
        {
            RetrieveResourceRequest request = new RetrieveResourceRequest("*", KnownContentTypes.ApplicationOctetStream, studyInstanceUid, seriesInstanceUid);
            var ex = await Assert.ThrowsAsync<InvalidIdentifierException>(() => _retrieveResourceHandler.Handle(request, CancellationToken.None));
        ...
        {
            RetrieveResourceRequest request = new RetrieveResourceRequest("*", KnownContentTypes.ApplicationOctetStream, TestUidGenerator.Generate(), seriesInstanceUid);
            var ex = await Assert.ThrowsAsync<InvalidIdentifierException>(() => _retrieveResourceHandler.Handle(request, CancellationToken.None));
        ...
        {
            RetrieveResourceRequest request = new RetrieveResourceRequest("*", KnownContentTypes.ApplicationOctetStream, TestUidGenerator.Generate(), TestUidGenerator.Generate(), sopInstanceUid);
            var ex = await Assert.ThrowsAsync<InvalidIdentifierException>(() => _retrieveResourceHandler.Handle(request, CancellationToken.None));
        ...
        {
            RetrieveResourceRequest request = new RetrieveResourceRequest("*", KnownContentTypes.ApplicationOctetStream, TestUidGenerator.Generate(), TestUidGenerator.Generate(), sopInstanceUid, new List<int> { 1 });
            var ex = await Assert.ThrowsAsync<InvalidIdentifierException>(() => _retrieveResourceHandler.Handle(request, CancellationToken.None));
        ...
        {
            var request = new RetrieveResourceRequest(transferSyntax, KnownContentTypes.ApplicationOctetStream, TestUidGenerator.Generate());
        ...
        public async Task GivenARequestWithValidInstanceIdentifier_WhenRetrievingFrames_ThenNoExceptionIsThrown()
        {
            ...
            RetrieveResourceRequest request = new RetrieveResourceRequest("*", KnownContentTypes.ApplicationOctetStream, studyInstanceUid, seriesInstanceUid, sopInstanceUid, new List<int> { 1 });
