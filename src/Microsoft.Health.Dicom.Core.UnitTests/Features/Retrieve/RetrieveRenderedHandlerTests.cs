...
public class RetrieveRenderedHandlerTests
{
    ...
    public async Task GivenARequestWithInvalidStudyInstanceIdentifier_WhenHandlerIsExecuted_ThenDicomInvalidIdentifierExceptionIsThrown(string studyInstanceUid)
    {
        ...
        RetrieveRenderedRequest request = new RetrieveRenderedRequest(studyInstanceUid, seriesInstanceUid, sopInstanceUid, ResourceType.Instance, 0, 75, new[] { AcceptHeaderHelpers.CreateRenderJpegAcceptHeader() });
    ...
    public async Task GivenARequestWithInvalidFramNumber_WhenHandlerIsExecuted_ThenBadRequestExceptionIsThrown(int frame)
    {
        ...
        RetrieveRenderedRequest request = new RetrieveRenderedRequest(studyInstanceUid, seriesInstanceUid, sopInstanceUid, ResourceType.Frames, frame, 75, new[] { AcceptHeaderHelpers.CreateRenderJpegAcceptHeader() });
    ...
    public async Task GivenARequestWithValidInstanceInstanceIdentifier_WhenHandlerIsExecuted_ThenNoExceptionThrown()
    {
        ...
        RetrieveRenderedRequest request = new RetrieveRenderedRequest(studyInstanceUid, seriesInstanceUid, sopInstanceUid, ResourceType.Frames, 5, 75, new[] { AcceptHeaderHelpers.CreateRenderJpegAcceptHeader() });
