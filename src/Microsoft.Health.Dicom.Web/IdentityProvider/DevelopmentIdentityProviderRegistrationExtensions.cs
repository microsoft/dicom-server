...
namespace Microsoft.Health.Dicom.Web.IdentityProvider
{
    public static class DevelopmentIdentityProviderRegistrationExtensions
    {
        ...
        /// reads a testauthenvironment.json file and reshapes it to fit into the expected schema of the Dicom server
        ...
        private class DevelopmentAuthEnvironmentConfigurationSource : IConfigurationSource
        {
            ...
            private class Provider : JsonConfigurationProvider
            {
                ...
                public override void Load()
                {
                    ...
                    Data["DicomServer:Security:Authentication:Audience"] = DevelopmentIdentityProviderConfiguration.Audience;
                }
            }
        }
    }
