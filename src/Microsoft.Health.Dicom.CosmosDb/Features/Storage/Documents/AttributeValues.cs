...
namespace Microsoft.Health.Dicom.CosmosDb.Features.Storage.Documents
{
    public class AttributeValues
    {
        ...
        /// </summary>
        [JsonProperty(DocumentProperties.MinimumDateTimeValue, NullValueHandling = NullValueHandling.Ignore)]
        public DateTime? MinDateTime => Values.Where(x => x is DateTime).Min(x => (DateTime?)x);
        ...
        /// This value does not need to be serialized if the array does not contain any DateTime values.
        /// </summary>
        [JsonProperty(DocumentProperties.MaximumDateTimeValue, NullValueHandling = NullValueHandling.Ignore)]
        public DateTime? MaxDateTime => Values.Where(x => x is DateTime).Max(x => (DateTime?)x);

        [JsonProperty(DocumentProperties.Values)]
