...
namespace Microsoft.Health.Dicom.CosmosDb.Features.Health
{
    public class DicomCosmosHealthCheck : CosmosHealthCheck
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DicomCosmosHealthCheck"/> class.
        /// </summary>
        ...
        public DicomCosmosHealthCheck(
            ...
            ILogger<DicomCosmosHealthCheck> logger)
            : base(
                  documentClient,
                  configuration,
