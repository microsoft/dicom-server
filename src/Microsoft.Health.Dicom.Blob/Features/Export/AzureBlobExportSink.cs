...
internal sealed class AzureBlobExportSink : IExportSink
{
    ...
    public async Task<bool> CopyAsync(ReadResult value, CancellationToken cancellationToken = default)
    {
        ...
        using Stream sourceStream = await _source.GetStreamingFileAsync(value.Identifier.Version, value.Identifier.PartitionEntry.PartitionName, cancellationToken);
