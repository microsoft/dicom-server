...
namespace Microsoft.Health.Dicom.SqlServer.UnitTests.Features.Schema
{
    public class VersionRangeTests
    {
        ...
        [InlineData(SchemaVersion.V1, SchemaVersion.V3)]
        [InlineData(SchemaVersion.V2, SchemaVersion.V2)]
        public void GivenRange_WhenDeconstructing_ThenOutputProperties(SchemaVersion min, SchemaVersion max)
        {
            (SchemaVersion actualMin, SchemaVersion actualMax) = new VersionRange(min, max);
