...
public class DropInvalidMetadataTests : IClassFixture<FeatureEnabledTestFixture<Startup>>, IAsyncLifetime
{
    ...
    public DropInvalidMetadataTests(FeatureEnabledTestFixture<Startup> fixture)
    {
