...
public class HttpIntegrationTestFixture<TStartup> : IDisposable
{
    ...
    public IDicomWebClient GetDicomWebClient(string apiVersion = DicomApiVersions.V2)
    {
        return GetDicomWebClient(TestApplications.GlobalAdminServicePrincipal, apiVersion: apiVersion);
    }

    public IDicomWebClient GetDicomWebClient(TestApplication clientApplication, TestUser testUser = null, string apiVersion = DicomApiVersions.V2)
    {
