    ...
    public class SqlDataStoreTestsFixture : IAsyncLifetime
    {
        ...
        internal SqlDataStoreTestsFixture(string databaseName)
        {
            ...
            SqlIndexDataStoreFactory = new SqlIndexDataStoreFactory(
                SchemaInformation,
                new[] { new SqlIndexDataStoreV1(SqlConnectionWrapperFactory), new SqlIndexDataStoreV2(SqlConnectionWrapperFactory), new SqlIndexDataStoreV3(SqlConnectionWrapperFactory), new SqlIndexDataStoreV4(SqlConnectionWrapperFactory) });
