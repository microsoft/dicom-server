...
namespace Microsoft.Health.Dicom.Tests.Integration.Persistence
{
    public class DeleteServiceTests : IClassFixture<DeleteServiceTestsFixture>
    {
        ...
        {
            await _fixture.DeleteService.DeleteInstanceAsync(versionedInstanceIdentifier.StudyInstanceUid, versionedInstanceIdentifier.SeriesInstanceUid, versionedInstanceIdentifier.SopInstanceUid);
