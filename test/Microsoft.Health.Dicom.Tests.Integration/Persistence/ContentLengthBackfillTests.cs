...
public class ContentLengthBackfillTests : IClassFixture<SqlDataStoreTestsFixture>
{
    ...
    [Fact]
    public async Task
        GivenInstanceWithZeroAsContentLength_WhenInBetweenInstancesWithLengthSet_ExpectWatermarkRangeReturnedExcludesTheBeforeAndAfterInstances()
    {
    ...
    [Fact]
    public async Task GivenInstancesWithZeroAsContentLength_WhenTheresGapsInBetween_ExpectWatermarkRangeReturnedRepresentsGapsAndBatchSize()
    {
    ...
    {
        FileProperties zeroLengthFileProperties = new FileProperties { Path = "zeroLength.dcm", ETag = "E1230", ContentLength = 0 };
        var nonZeroLengthInstance = await CreateRandomInstanceAsync(); // This instance will have a content length set/ non zero.
