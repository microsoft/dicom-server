...
1. (Optional) If you want to create a client secret, select **Certificates & Secrets** > **New client secret** > **Add**. Copy the client secret value shown in the page. *Note, you will need to create a client secret to retrieve an access token via Postman*.

## Set the Authentication of your App Service

1. Navigate to your Dicom App Service that you deployed to Azure.
1. Select **Authentication / Authority**, turn on **App Service Authentication** and select **Save**.
1. Select **Configuration** to update the **Audience** and **Authority**:
    1. Set the **Application ID URI** enabled above as the **Audience**.
    1. **Authority** is whichever tenant your application exists in, for example: https://login.microsoftonline.com.

## Get Access Token Using Azure CLI

To obtain an access token using Azure CLI:

1. Provide your Application Registration above access to the Azure CLI:
...
1. Create a new **Post** Request with the following form-data:
    ...
    1. *client_id*: the **Client ID** for your Azure App registration.
    1. *grant_type*: "client_credentials"
    1. *client_secret*: the **Client secret** for your Azure App Registration.
    1. *resource*: the **Application ID URI** for your Azure App registration.
