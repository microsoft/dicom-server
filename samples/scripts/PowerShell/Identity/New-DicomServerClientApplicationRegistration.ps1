function New-DicomServerClientApplicationRegistration {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
    New-DicomServerClientApplicationRegistration -DisplayName "clientapplication" -ApiAppId 9125e524-1509-XXXX-XXXX-74137cc75422
    .PARAMETER ApiAppId
