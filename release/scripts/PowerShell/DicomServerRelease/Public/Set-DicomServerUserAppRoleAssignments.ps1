function Set-DicomServerUserAppRoleAssignments {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
    Set-DicomServerUserAppRoleAssignments -UserPrincipalName <User Principal Name> -ApiAppId <Resource Api Id> -AppRoles globalReader,globalAdmin
