function Set-DicomServerClientAppRoleAssignments {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
    Set-DicomServerClientAppRoleAssignments -AppId <Client App Id> -ApiAppId <Resource Api Id> -AppRoles globalReader,globalAdmin
    .PARAMETER AppId
